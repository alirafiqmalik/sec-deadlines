...
| `tags`        | One or multiple [tags][3]: `SEC`, `CRYPTO`, `QUANTUM`, `PQC`, `FORMAL`, or `AI` (topic); `CONF`, `WORKSHOP`, `TUTORIAL`, `POSTER`, or `TOOLS` (venue);<br> `TOP4`, `CORE-A`, `CORE-B`, `CORE-C`, or `OTHERS` (rank). |
